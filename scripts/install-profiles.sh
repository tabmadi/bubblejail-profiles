...
#
# Usage:
#   ./scripts/install-profiles.sh                 # install all profiles
#   ./scripts/install-profiles.sh firefox tor     # install specific profiles
#   ./scripts/install-profiles.sh --copy          # copy instead of symlink
#   ./scripts/install-profiles.sh --list          # list available profiles
